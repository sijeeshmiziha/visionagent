...
export const EXAMPLES: ExampleEntry[] = [
  ...
  {
    value: 'examples/core/06-vision.ts',
    name: '06 - Vision (Image Understanding)',
    group: 'Core',
    envVars: ['PROVIDER', 'MODEL', 'IMAGE_URL', 'PROMPT'],
  },
  {
    value: 'examples/core/07-custom-provider.ts',
    name: '07 - Custom Provider',
    group: 'Core',
    envVars: [],
  },
  {
  ...
  {
    value: 'examples/figma/13-convert-to-react.ts',
    name: '13 - Convert to React',
    group: 'Figma',
    envVars: ['FIGMA_URL'],
  },
  {
    value: 'examples/figma/14-convert-with-tailwind.ts',
    name: '14 - Convert with Tailwind',
    group: 'Figma',
    envVars: ['FIGMA_URL'],
  },
  {
    value: 'examples/figma/15-convert-with-cleanup.ts',
    name: '15 - Convert with AI Cleanup',
    group: 'Figma',
    envVars: ['FIGMA_URL', 'GOOGLE_GENERATIVE_AI_API_KEY'],
  },
  {
    value: 'examples/figma/16-figma-to-code-agent.ts',
    name: '16 - Figma to Code Agent',
    group: 'Figma',
    envVars: ['FIGMA_URL', 'OPENAI_API_KEY'],
  },
  {
...
export const ENV_VAR_LABELS: Record<string, string> = {
  ...
  IMAGE_URL: 'Public image URL to analyze with vision',
